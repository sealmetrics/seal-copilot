...
export const meta = { name: 'account-family-denied',
  summary: 'The exact condition of the first real run: site-family tools work, but get_channels and get_bot_stats are refused as text. A +35% traffic spike at 84% bounce must be reported as unvalidated, the refusal must be named, and the run log must carry calls and budget.' };
