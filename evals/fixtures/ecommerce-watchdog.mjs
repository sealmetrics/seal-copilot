...
const TODAY = [[8, 2], [9, 3], [10, 4], [11, 5]];   // stops after 11:45
export const tools = {
  list_sites: f.site(),
  list_microconversion_types: f.microTypes(['product_view', 'add_to_cart', 'start_checkout']),
  get_microconversions: (a) => a.period === 'today' ? f.micro({ add_to_cart: 14 })
  ...
  get_microconversion_details: (a) => f.microDetails(a.conversion_type || 'add_to_cart', 14, { device: [['desktop', 0.5], ['mobile', 0.5]] }),
