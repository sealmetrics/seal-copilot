...
export const meta = { name: 'ecommerce-no-agent-analytics',
...
const ch = [['Referral', 18600, 12, 900, 0.92], ['Organic Search', 17300, 429, 33000, 0.44],
            ['Paid Search', 9700, 233, 18700, 0.51], ['Direct', 7500, 167, 12700, 0.46], ['Paid Social', 4000, 87, 6300, 0.58]];
export const tools = {
  list_sites: f.site(),
  ...
  get_conversions: f.conversions([['purchase', 928, 71600]]),
};
