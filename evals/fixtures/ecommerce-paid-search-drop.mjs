...
export const tools = {
  ...
  get_channels: (a) => f.rows('channel', ['last_week', 'last_month', 'last_quarter', 'last_year'].includes(a.period) ? chPrev : chNow),
  get_top_channels: f.top('channel', chNow.slice(0, 3)),
